...
Note that this project was to be completed using a source code editor such as [Visual Studio Code](https://code.visualstudio.com) rather than a notebook applicaton such as the  [Jupyter Notebook](https://jupyter-notebook.readthedocs.io/en/stable/) application.   
As per the project requirements, the project [README](https://github.com/angela1C/Programming-and-Scripting-Project#readme) contains an overview of the project, my research into the Iris dataset, visualisations of the Iris datasets generated by the Python scripts as well as some Python code snippets, detailed explanations and discussion as well as a list of all references used.    
...
As outlined in the [Programming and Scripting Project 2019](https://github.com/ianmcloughlin/problems-pands-2019/blob/master/problems.pdf) 
instructions, the project should achieve the following goals:
